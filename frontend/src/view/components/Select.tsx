    ...
    <div>
      <div className="relative">
        <RdxSelect.Root>
          <RdxSelect.Trigger
            className={cn(
              "bg-white w-full rounded-lg border border-gray-500 px-3 h-[52px] text-gray-800 focus:border-gray-900 transition-alloutline-none text-left relative",
            ...
            <RdxSelect.Content className=" z-[99] overflow-hidden bg-white rounded-2xl border border-gray-100 shadow-[0px_11px_20px_0px_rgba(0,0,0,0.10)]">
              ...
              <RdxSelect.Viewport className="p-2">
                ...
                <RdxSelect.Item
                  ...
                  value="Tangerina"
                >
                  <RdxSelect.ItemText>Tangerina</RdxSelect.ItemText>
                </RdxSelect.Item>
              </RdxSelect.Viewport>
