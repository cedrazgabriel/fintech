...
export function SliderNavigation (){
    ...
    return(
        <>
        <button className="absolute left-0 top-1/2 -translate-y-1/2 w-12 h-12 flex items-center justify-center z-10 bg-gradient-to-r from-gray-100 to-transparent"
